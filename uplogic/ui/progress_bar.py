...
class ProgressBar(Widget):
    ...
    def _draw(self):
        ...
        mid_x = self.gpu_view_position[0][0] + (
            self.gpu_view_position[1][0] - self.gpu_view_position[0][0]) * self._percent
        ...
        batch = batch_for_shader(self.shader, 'TRIS', {
                                 "pos": fill_vertices, "color": self.fill_colors}, indices=fill_indices)
        ...
        batch = batch_for_shader(self.shader, 'TRIS', {
                                 "pos": bg_vertices, "color": self.bg_colors}, indices=bg_indices)
        batch.draw(self.shader)
