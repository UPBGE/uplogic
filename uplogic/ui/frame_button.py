...
class FrameButton(Widget):
    ...
    def __init__(self, parent, name=None, base_color=None, text="", font=None,
        ...
        self.frame = Frame(self, size=[1, 1], pos=[
                           0, 0], options=BGUI_NO_THEME)
        self.label = Label(self, text=text, font=font, pt_size=pt_size, pos=[
                           0, 0], sub_theme=self.theme['LabelSubTheme'], options=BGUI_DEFAULT | BGUI_CENTERED)
