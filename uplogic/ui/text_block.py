...
class TextBlock(Widget):
    ...
    def text(self, value):
        ...
        cur_line = 0
        line = Label(self, "tmp", "Mj|", font=self._font, pt_size=self._pt_size,
                     color=self._color, sub_theme=self.theme['LabelSubTheme'])
        self._remove_widget(line)
        ...
        for words in lines:
            line = Label(self, "lines_" + str(cur_line), "", self._font, self._pt_size, self._color,
                         pos=[0, 1 - (cur_line + 1) * char_height], sub_theme=self.theme['LabelSubTheme'])
            ...
            while words:
                ...
                if line.size[0] > self.size[0]:
                    ...
                    cur_line += 1
                    line = Label(self, "lines_" + str(cur_line), "", self._font, self._pt_size, self._color, pos=[
                                 0, 1 - (cur_line + 1) * char_height], sub_theme=self.theme['LabelSubTheme'])
                else:
                ...
                if self.overflow == BGUI_OVERFLOW_HIDDEN:
                    ...
                    for line in self._lines:
                        line._update_position(
                            line.size, [0, line._base_pos[1] + char_height])
